...
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/cityman/system/build.prop)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/cityman/system/build.prop)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/cityman/system/build.prop)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/cityman/system/build.prop)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/cityman/system/build.prop)
...
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/cityman/system/build.prop)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/cityman/system/build.prop)
$(call add-clean-step, find $(OUT_DIR)/target/product/cityman/ -name \*build.prop* -exec rm -rf {} \;)
$(call add-clean-step, find $(OUT_DIR)/target/product/cityman/ -name \*build.prop* -exec rm -rf {} \;)
$(call add-clean-step, find $(OUT_DIR)/target/product/cityman/ -name \*build.prop* -exec rm -rf {} \;)
$(call add-clean-step, find $(OUT_DIR)/target/product/cityman/ -name \*build.prop* -exec rm -rf {} \;)
$(call add-clean-step, find $(OUT_DIR)/target/product/cityman/ -name \*build.prop* -exec rm -rf {} \;)
